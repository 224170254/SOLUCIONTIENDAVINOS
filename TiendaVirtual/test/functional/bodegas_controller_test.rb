...
class BodegasControllerTest < ActionController::TestCase
  ...
  test "should create bodega" do
    assert_difference('Bodega.count') do
      post :create, bodega: { correo: @bodega.correo, direccion: @bodega.direccion, nombre: @bodega.nombre, rut: @bodega.rut, telefono1: @bodega.telefono1, telefono2: @bodega.telefono2 }
    end
  ...
  test "should update bodega" do
    put :update, id: @bodega, bodega: { correo: @bodega.correo, direccion: @bodega.direccion, nombre: @bodega.nombre, rut: @bodega.rut, telefono1: @bodega.telefono1, telefono2: @bodega.telefono2 }
    assert_redirected_to bodega_path(assigns(:bodega))
  end
